...
#ifndef AnalyzeChi2_h
#define AnalyzeChi2_h
...
class AnalyzeChi2 : public TSelector {
public :
   ...
   ClassDef(AnalyzeChi2,0);

};

#endif

#ifdef AnalyzeChi2_cxx
void AnalyzeChi2::Init(TTree *tree)
{
