...
#ifndef AnalyzeExercise7_h
#define AnalyzeExercise7_h
...
class AnalyzeExercise7 : public TSelector {
public :
   ...
   AnalyzeExercise7(TTree * /*tree*/ =0) { }
   virtual ~AnalyzeExercise7() { }
   ...
   ClassDef(AnalyzeExercise7,0);

};

#endif

#ifdef AnalyzeExercise7_cxx
void AnalyzeExercise7::Init(TTree *tree)
{
...
Bool_t AnalyzeExercise7::Notify()
{
...
#endif // #ifdef AnalyzeExercise7_cxx
