...
#ifndef AnalyzeExercise10_h
#define AnalyzeExercise10_h
...
class AnalyzeExercise10 : public TSelector {
public :
   ...
   AnalyzeExercise10(TTree * /*tree*/ =0) { }
   virtual ~AnalyzeExercise10() { }
   ...
   ClassDef(AnalyzeExercise10,0);

};

#endif

#ifdef AnalyzeExercise10_cxx
void AnalyzeExercise10::Init(TTree *tree)
{
...
Bool_t AnalyzeExercise10::Notify()
{
...
#endif // #ifdef AnalyzeExercise10_cxx
