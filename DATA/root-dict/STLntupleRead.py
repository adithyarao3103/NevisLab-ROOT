...
# STLntupleRead.cxx. It's meant to demonstrate using Python to work
...
from ROOT import gDirectory, gInterpreter

# This is the Python-ized version of the code in STLntuple.icc. 
